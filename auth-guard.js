// auth-guard.js - Guardián de Autenticación e Inyección Dinámica de Navbar
...
(async function verificarAccesoSeguro() {
  ...
  // 2. Inyectar Navbar dinámico al cargar el DOM
  document.addEventListener('DOMContentLoaded', () => {
    inyectarNavbarDinamico(rutaActual);
  });
})();

// Función que renderiza la barra superior en todas las páginas
function inyectarNavbarDinamico(paginaActual) {
  // Si ya existe un nav estático en la página, lo reemplazamos
