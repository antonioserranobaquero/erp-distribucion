// auth-guard.js - Control de Acceso por Roles (RBAC), Menú Dinámico y Modo Inspección SuperAdmin
(function authGuardAndNavbar() {
  ...
  // Priorizar empresa inspeccionada si existe en localStorage
      ...
      <div id="erp-navbar-root" class="w-full no-print">
        <nav class="bg-[#0f172a] text-white border-b border-slate-800 sticky top-0 z-50">
          <div class="max-w-[1700px] mx-auto px-4 flex items-center justify-between h-14">
            ...
            <!-- LOGO DINÁMICO DE LA EMPRESA ACTIVA -->
        ...
        <!-- BANNER DE INSPECCIÓN SUPERADMIN -->
          ...
          <div class="bg-amber-500 text-slate-950 px-4 py-1.5 text-xs font-black flex justify-between items-center shadow-md border-b border-amber-600">
            <div class="flex items-center gap-3">
              <span class="flex items-center gap-1.5">
                ...
                MODO INSPECCIÓN SUPERADMIN: Viendo exclusivamente los datos de "${empresaNombre}"
              </span>
            </div>
...
// Función única y centralizada para obtener el ID de empresa activa
