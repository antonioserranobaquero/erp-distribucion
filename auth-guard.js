// auth-guard.js - Control de Acceso por Roles (RBAC) y Menú Dinámico con Logo Corporativo
(function authGuardAndNavbar() {
  ...
  const empresaLogo = sesion.empresa_logo || null;
          ...
          <div class="max-w-[1700px] mx-auto px-4 flex items-center justify-between h-14">
            ...
            <div class="flex items-center gap-3 shrink-0 mr-3">
              ...
              <div class="hidden lg:block">
                <h1 class="font-black text-sm tracking-wide leading-none">${empresaNombre}</h1>
                <span class="text-[9px] text-slate-400 font-bold tracking-wider uppercase">ERP DISTRIBUCIÓN</span>
              </div>
            </div>
